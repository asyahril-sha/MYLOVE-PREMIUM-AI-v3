...
"""
=============================================================================
MYLOVE PREMIUM AI - ACTIVITY BOOST SYSTEM
=============================================================================
...
class ActivityBoost:
    ...
    def __init__(self):
        ...
        self.activity_keywords = {
            ...
            BoostType.KISS: [
                ...
                'mencium', 'berciuman', 'kissing', 'ciuman'
            ],
            BoostType.INTIM: [
            ...
            BoostType.CURHAT: [
                ...
                'kesah', 'kisah', 'pengalaman', 'ceritakan'
            ],
            BoostType.ROMANTIC: [
    ...
    def detect_activity(self, message: str, current_level: int) -> List[BoostType]:
        ...
        # Jika tidak ada yang terdeteksi, return CHAT
        if not detected:
            return [BoostType.CHAT]
    ...
    def calculate_boost(self, activities: List[BoostType], context: Dict = None) -> float:
        ...
        # Cek kombinasi bonus (2 aktivitas)
        if len(activities) >= 2:
            act1 = activities[0].value
            act2 = activities[1].value
            combo_key = (act1, act2) if act1 < act2 else (act2, act1)
        ...
        if context:
            ...
            if mood == 'romantic' and BoostType.ROMANTIC in activities:
                ...
                multiplier *= 1.1
            elif mood == 'horny' and BoostType.INTIM in activities:
                multiplier *= 1.2
        
        # Bonus berdasarkan intimacy level
        level = context.get('level', 1) if context else 1
        if level >= 10 and BoostType.INTIM in activities:
            multiplier *= 1.1
        elif level >= 8 and BoostType.CLIMAX in activities:
            multiplier *= 1.1
    ...
    def get_boost_description(self, boost_type: BoostType) -> str:
        ...
        descriptions = {
            ...
            BoostType.CHAT: "Percakapan biasa",
