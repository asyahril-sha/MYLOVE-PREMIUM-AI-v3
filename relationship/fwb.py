...
class FWBManager:
    ...
    async def get_fwb_by_name(self, user_id: int, bot_name: str) -> Optional[Dict]:
        """
        Dapatkan FWB berdasarkan nama bot
        ...
        for fwb_id, fwb in self.fwb_relations[user_id].items():
            if fwb['bot_name'].lower() == bot_name.lower():
                return fwb
