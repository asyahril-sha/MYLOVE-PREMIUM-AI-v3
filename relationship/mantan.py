...
"""
=============================================================================
MYLOVE PREMIUM AI - MANTAN MANAGER
=============================================================================
...
class MantanManager:
    ...
    def get_mantan_by_name(self, user_id: int, bot_name: str) -> Optional[Dict]:
        """Dapatkan mantan berdasarkan nama bot"""
        mantans = self.get_mantan_list(user_id)
        for mantan in mantans:
            if mantan['bot_name'].lower() == bot_name.lower():
                return mantan
        return None
    ...
    def get_random_flashback(self, user_id: int, mantan_id: str) -> Optional[Dict]:
        """Dapatkan flashback random untuk mantan"""
        return self.get_flashback(user_id, mantan_id)
