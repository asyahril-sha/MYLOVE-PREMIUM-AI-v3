...
"""
=============================================================================
MYLOVE PREMIUM AI - CUSTOM EXCEPTIONS
=============================================================================
Exception hierarchy untuk error handling yang robust
"""
...
def global_exception_handler(exc_type, exc_value, exc_traceback):
    ...
    logger.opt(exception=(exc_type, exc_value, exc_traceback)).critical("🔥 Uncaught exception in MYLOVE PREMIUM AI")
