...
"""
=============================================================================
MYLOVE PREMIUM AI - PERFORMANCE MONITORING
=============================================================================
Tracking response time, memory usage, performance decorators
"""
...
class PerformanceMonitor:
    ...
    def __init__(self, max_history: int = 1000):
        ...
        # Thresholds
        self.slow_threshold = getattr(settings.performance, 'target_response_time', 5.0) if hasattr(settings, 'performance') else 5.0
        self.memory_warning_mb = getattr(settings.performance, 'max_memory_mb', 500) * 0.8 if hasattr(settings, 'performance') else 400
    ...
    def check_health(self) -> Dict[str, str]:
        ...
        if self.response_times:
            recent = list(self.response_times)[-100:]
        ...
        if self.memory_samples:
            ...
            max_mem = getattr(settings.performance, 'max_memory_mb', 500) if hasattr(settings, 'performance') else 500
