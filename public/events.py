...
"""
=============================================================================
MYLOVE PREMIUM AI - RANDOM EVENTS SYSTEM
=============================================================================
...
class RandomEvents:
    ...
    def __init__(self):
        ...
        self.positive_events = [
            ...
            {
                "id": "pemadaman_listrik",
                "name": "🔌 Pemadaman Listrik",
                "description": "Listrik padam, gelap total selama beberapa menit",
                "risk_change": -45,
                "thrill_change": 35,
                "continuation": "lanjut",
                "message": "Listrik padam! Waktu yang tepat!",
                "probability": 0.06
            }
        ]
        ...
        self.negative_events = [
            ...
            },
            {
                "id": "bunyi_petasan",
                "name": "🧨 Bunyi Petasan",
                "description": "Suara petasan mengagetkan",
                "risk_change": 15,
                "thrill_change": 20,
                "continuation": "lanjut",
                "message": "Suara petasan! Kaget!",
                "probability": 0.07
            }
        ]
        ...
        self.neutral_events = [
            ...
            },
            {
                "id": "kunang_kunang",
                "name": "✨ Kunang-kunang",
                "description": "Kunang-kunang bertebaran, indah",
                "risk_change": 0,
                "thrill_change": 10,
                "continuation": "lanjut",
                "message": "Kunang-kunang! Romantis banget!",
                "probability": 0.05
            },
            {
                "id": "daun_jatuh",
                "name": "🍂 Daun Jatuh",
                "description": "Daun-daun berguguran",
                "risk_change": 0,
                "thrill_change": 5,
                "continuation": "lanjut",
                "message": "Daun-daun berguguran...",
                "probability": 0.1
            }
        ]
    ...
    async def get_random_event(
        ...
        if time_category in ["tengah_malam", "malam"]:
            ...
            base_prob *= 0.8  # Siang lebih sedikit event
