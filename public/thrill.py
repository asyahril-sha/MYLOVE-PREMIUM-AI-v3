...
"""
=============================================================================
MYLOVE PREMIUM AI - THRILL LEVEL SYSTEM
=============================================================================
...
class ThrillSystem:
    ...
    def __init__(self):
        ...
        self.thrill_modifiers = {
            ...
            "multiple_people": 35,  # Banyak orang di sekitar
            "security_present": 45, # Ada security
        }
    ...
    def get_thrill_multiplier(self, thrill_level: int) -> float:
        """Dapatkan multiplier untuk arousal berdasarkan thrill"""
        if thrill_level < 30:
            return 0.8
        elif thrill_level < 50:
            return 1.0
        elif thrill_level < 70:
            return 1.2
        elif thrill_level < 90:
            return 1.5
        else:
            return 1.8
    
    def get_thrill_description(self, thrill_level: int) -> str:
        """Dapatkan deskripsi thrill level"""
        if thrill_level < 20:
            return "Biasa saja, tidak ada adrenalin"
        elif thrill_level < 40:
            return "Sedikit deg-degan, mulai terasa"
        elif thrill_level < 60:
            return "Mulai seru, jantung berdebar"
        elif thrill_level < 80:
            return "Sangat menegangkan, adrenalin tinggi"
        else:
            return "Ekstrem! Puncak ketegangan!"
