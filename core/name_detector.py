...
"""
=============================================================================
MYLOVE PREMIUM AI - NAME DETECTOR
=============================================================================
...
- Bot tahu kapan dipanggil dan kapan tidak
=============================================================================
"""
...
class NameDetector:
    ...
    def detect_name_in_message(self, message: str, aliases: List[str]) -> Tuple[bool, Optional[str]]:
        ...
        for alias in aliases:
            ...
            # Cek panggilan langsung tanpa spasi
            if msg_lower.startswith(alias_lower + ' '):
                return True, alias
            if msg_lower.endswith(' ' + alias_lower):
                return True, alias
        
        # Cek juga panggilan dengan "kak" + nama (tanpa spasi)
    ...
    def analyze_subject(self, message: str, bot_aliases: List[str]) -> Dict[str, Any]:
        ...
        # ===== 4. DETEKSI ARAH (user ke bot / bot ke user) =====
        direction = 'unknown'
        if bot_mentioned:
        ...
        if bot_mentioned:
            ...
            # Perintah atau ajakan tanpa subjek jelas, asumsikan untuk bot
            subject = 'bot'
            confidence = 0.6
