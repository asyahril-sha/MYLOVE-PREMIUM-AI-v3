...
class MoodSwing:
    ...
    def __init__(self):
        ...
        self.factors = {
            'time': {
                'morning': {MoodType.HAPPY: 0.2, MoodType.TIRED: 0.1, MoodType.EXCITED: 0.15},
                'afternoon': {MoodType.EXCITED: 0.2, MoodType.HAPPY: 0.1, MoodType.TIRED: 0.15},
                'evening': {MoodType.ROMANTIC: 0.2, MoodType.CALM: 0.2, MoodType.PLAYFUL: 0.1},
                'night': {MoodType.HORNY: 0.3, MoodType.ROMANTIC: 0.3, MoodType.LONELY: 0.2, MoodType.CALM: 0.1}
            },
            'idle': {
                5: {MoodType.LONELY: 0.1, MoodType.BORED: 0.2},
                15: {MoodType.LONELY: 0.2, MoodType.ANXIOUS: 0.1, MoodType.SAD: 0.1},
                30: {MoodType.SAD: 0.2, MoodType.LONELY: 0.3, MoodType.BORED: 0.2}
            },
            'intimacy_level': {
                1: {MoodType.SHY: 0.3, MoodType.NEUTRAL: 0.4, MoodType.CALM: 0.2},
                4: {MoodType.PLAYFUL: 0.2, MoodType.HAPPY: 0.3, MoodType.ROMANTIC: 0.2},
                7: {MoodType.HORNY: 0.3, MoodType.ROMANTIC: 0.3, MoodType.PASSIONATE: 0.2},
                10: {MoodType.PASSIONATE: 0.4, MoodType.SENSITIVE: 0.2, MoodType.ROMANTIC: 0.2}
            }
        }
    ...
    def _get_event_effect(self, event: str, intensity: float) -> Optional[Dict]:
        ...
        effects = {
            ...
            'compliment': {'mood': MoodType.HAPPY, 'intensity': 0.15},
            'curhat': {'mood': MoodType.CALM, 'intensity': 0.1}
        }
