...
"""
=============================================================================
MYLOVE PREMIUM AI - LOCATION VALIDATOR (VERSI HUMAN+)
=============================================================================
...
class LocationValidator:
    ...
    def __init__(self):
        ...
        self.valid_transitions = {
            # Indoor
            'ruang tamu': ['kamar', 'dapur', 'teras', 'kamar mandi', 'taman', 'balkon'],
            'kamar': ['kamar mandi', 'ruang tamu', 'balkon'],
            'kamar mandi': ['kamar', 'ruang tamu', 'dapur'],
            'dapur': ['ruang tamu', 'kamar mandi', 'teras'],
            'teras': ['ruang tamu', 'taman', 'jalan'],
            'balkon': ['kamar', 'ruang tamu'],
            
            # Outdoor
            'taman': ['teras', 'ruang tamu', 'jalan', 'pantai'],
            'pantai': ['mobil', 'kafe', 'rumah', 'jalan', 'taman'],
            'jalan': ['taman', 'pantai', 'mall', 'kafe', 'rumah'],
            
            # Public
            'mall': ['parkiran', 'mobil', 'kafe', 'jalan', 'parkir'],
            'kafe': ['mall', 'pantai', 'jalan', 'mobil', 'rumah'],
            'kantor': ['ruang tamu', 'mobil', 'jalan', 'parkiran'],
            
            # Transport
            'mobil': ['pantai', 'mall', 'rumah', 'parkiran', 'kafe', 'jalan', 'kantor'],
            'parkiran': ['mobil', 'mall', 'kantor'],
            'rumah': ['ruang tamu', 'kamar', 'dapur', 'teras', 'mobil', 'taman'],
        }
        ...
        self.special_patterns = {
            'ajakan': ['yuk', 'ayo', 'mari', 'gas', 'ke sana'],
            'perintah': ['pindah', 'kesini', 'kemari', 'sini', 'datang'],
            'pertanyaan': ['di mana', 'lagi apa', 'di mana kamu'],
            'cerita': ['aku ', 'saya ', 'gue ', 'gw '],
        }
        
        # ===== JARAK ANTAR LOKASI (dalam menit) =====
    ...
    def validate_move(self, 
        ...
        if not subject_rule['should_follow']:
            ...
            info['suggested_response'] = f"Oh kamu ke {to_loc}? Aku tetap di {from_loc}"
    ...
    def _find_alternative_route(self, from_loc: str, to_loc: str) -> Optional[str]:
        ...
        # Cari hub umum
        common_hubs = ['ruang tamu', 'kamar', 'teras', 'mobil', 'rumah']
    ...
    def analyze_subject(self, message: str) -> Dict:
        ...
        location_indicators = ['ke ', 'pindah', 'pergi', 'kesana', 'kesini']
    ...
    def extract_location(self, message: str) -> Optional[str]:
        ...
        locations = [
            'ruang tamu', 'kamar', 'dapur', 'kamar mandi', 'toilet', 'wc',
            'teras', 'taman', 'pantai', 'mall', 'kafe', 'kantor',
            'mobil', 'rumah', 'balkon', 'jalan', 'parkiran'
        ]
        
        for loc in locations:
            if loc in msg:
                # Pastikan ada indikator lokasi
                indicators = ['ke ', 'di ', 'pindah ke', 'pergi ke', 'kesana', 'menuju']
    ...
    def get_suggested_response(self, 
        ...
        if subject == 'self':
            ...
            if analysis['is_question']:
                ...
                return f"Ok, aku pindah ke sana"
            else:
