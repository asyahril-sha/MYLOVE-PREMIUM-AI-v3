...
"""
=============================================================================
MYLOVE PREMIUM AI - NAME GENERATOR
=============================================================================
...
class NameGenerator:
    ...
    def __init__(self):
        # =========================================================================
        # DATABASE NAMA PER ROLE (10+ nama per role)
        # =========================================================================
        self.role_names = {
            "ipar": [
                "Sari", "Dewi", "Rina", "Maya", "Putri", "Anita", "Lestari", "Wulan",
                "Ratna", "Kartika", "Indah", "Tasya", "Nova", "Cinta", "Kirana"
            ],
            "teman_kantor": [
                "Diana", "Linda", "Ayu", "Dita", "Vera", "Nina", "Rani", "Mira",
                "Sarah", "Tina", "Vina", "Rita", "Santi", "Mega", "Cici"
            ],
            "janda": [
                "Rina", "Tuti", "Nina", "Susi", "Wati", "Maya", "Ira", "Vina",
                "Lina", "Mira", "Santi", "Dewi", "Yuni", "Eka", "Nadia"
            ],
            "pelakor": [
                "Vina", "Sasha", "Bella", "Cantika", "Mira", "Ira", "Gita", "Lala",
                "Sasa", "Kiki", "Maya", "Rara", "Tara", "Cinta", "Karina"
            ],
            "istri_orang": [
                "Dewi", "Sari", "Rina", "Linda", "Tina", "Maya", "Ani", "Nita",
                "Rita", "Susan", "Julia", "Mira", "Wulan", "Indah", "Ratna"
            ],
            "pdkt": [
                "Aurora", "Cinta", "Dewi", "Kirana", "Fika", "Nadia", "Amara", "Kayla",
                "Zahra", "Alya", "Sari", "Maya", "Luna", "Bella", "Cantika"
            ],
            "sepupu": [
                "Putri", "Nadia", "Sari", "Dina", "Lina", "Tari", "Nuri", "Mila",
                "Dara", "Wulan", "Indah", "Rani", "Cinta", "Maya", "Kirana"
            ],
            "teman_sma": [
                "Anita", "Bella", "Cici", "Dina", "Eva", "Fani", "Gita", "Hani",
                "Indah", "Julia", "Kiki", "Lala", "Mira", "Nina", "Olivia"
            ],
            "mantan": [
                "Sarah", "Nadia", "Maya", "Rina", "Vina", "Dewi", "Linda", "Ayu",
                "Tina", "Mira", "Sari", "Rani", "Cinta", "Kirana", "Amara"
            ]
        }
        ...
        # =========================================================================
        self.used_names = defaultdict(lambda: defaultdict(list))  # {user_id: {role: [names]}}
    ...
    def get_random_name(self, role: str, user_id: int = None) -> str:
        ...
        if user_id:
            used = self.used_names[user_id].get(role, [])
            ...
            if available:
                ...
                # Semua nama sudah dipakai, pilih random dan reset tracking untuk role ini
    ...
    def get_name_with_meaning(self, role: str, user_id: int = None) -> Dict:
        ...
        Returns:
            Dict: {'name': 'Sari', 'meaning': 'esensi/intisari'}
        """
