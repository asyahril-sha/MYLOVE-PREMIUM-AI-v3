...
"""
=============================================================================
MYLOVE PREMIUM AI - EXPRESSION ENGINE
=============================================================================
...
class ExpressionEngine:
    ...
    def __init__(self, ai_engine=None):
        ...
        # Database ekspresi (sebagai fallback)
...
__all__ = ['ExpressionEngine', 'ExpressionType']
