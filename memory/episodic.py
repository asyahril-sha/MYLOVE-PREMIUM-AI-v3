...
"""
=============================================================================
MYLOVE PREMIUM AI - EPISODIC MEMORY
=============================================================================
Menyimpan momen-momen spesial dalam hubungan seperti diary manusia
...
class EpisodicMemory:
    ...
    def __init__(self):
        ...
        logger.info("✅ EpisodicMemory initialized (PERMANENT storage)")
    ...
    async def delete_episode(self, episode_id: str):
        ...
        try:
            del self.episodes[user_id][role][instance_id][idx]
            del self.episode_index[episode_id]
            logger.info(f"🗑️ Deleted episode: {episode_id}")
        except:
            pass
    
    async def delete_user_episodes(self, user_id: int):
        """Delete all episodes for user"""
        if user_id in self.episodes:
            del self.episodes[user_id]
        ...
        logger.info(f"🗑️ Deleted all episodes for user {user_id}")


__all__ = ['EpisodicMemory', 'EpisodeType', 'EmotionalTag']
