...
"""
=============================================================================
MYLOVE PREMIUM AI - SESSION STORAGE
=============================================================================
...
class SessionStorage:
    ...
    async def create_session(self, user_id: int, role: str, bot_name: str) -> Dict:
        """
        Create new session
        ...
        session_id = id_generator.generate_v2(bot_name, role, user_id)
        ...
        await self.conn.execute('''
            ...
            (id, bot_name, role, user_id, date, sequence, start_time, last_message_time, status)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
        ''', (
            session_id,
            bot_name,
